---
title: Create Avalanche Sovereign L1
description: This page demonstrates how to create an Avalanche Sovereign L1 using Avalanche-CLI.
---

This tutorial walks you through the process of using Avalanche-CLI to create a sovereign Avalanche L1, deploy it to a local network, and connect to it with Core wallet.
...
### Choose Your Validator Management Type[​](#choose-your-vm "Direct link to heading")

Select `Proof Of Authority`.

`Proof Of Stake` validator management type is currently not supported and will be coming soon.

### Enter An Address To Be The Controller Of The Validator Manager Contract[​](#choose-your-vm "Direct link to heading")

This is the address that will be able to add and remove validator sets of the blockchain.

If you do not have any address, exit this command and call `avalanche key create` to create a new
address.

### Specify Blockchain Config Values [​](#choose-your-vm "Direct link to heading")

If you plan to deploy the blockchain to Fuji / Mainnet / a public Devnet, select `I want to use defaults for a production environment`,
otherwise select `I want to use defaults for a test environment`.

Blockchain configuration default values:
- Use latest Subnet-EVM release
- Allocate 1 million native tokens to:
